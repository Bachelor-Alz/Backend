...
namespace HealthDevice.Migrations
{
    ...
    [Migration("20250427111504_InvitesUpdate")]
    partial class InvitesUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaregiverElder", b =>
                {
                    b.Property<string>("CaregiversId")
                        .HasColumnType("text");

                    b.Property<string>("EldersId")
                        .HasColumnType("text");

                    b.HasKey("CaregiversId", "EldersId");

                    b.HasIndex("EldersId");

                    b.ToTable("CaregiverElder");
                });

            modelBuilder.Entity("CaregiverElder1", b =>
                {
                    b.Property<string>("InvitedCaregiversId")
                        .HasColumnType("text");

                    b.Property<string>("InvitesId")
                        .HasColumnType("text");

                    b.HasKey("InvitedCaregiversId", "InvitesId");

                    b.HasIndex("InvitesId");

                    b.ToTable("CaregiverElder1");
                });
            ...
            modelBuilder.Entity("CaregiverElder1", b =>
                {
                    b.HasOne("HealthDevice.DTO.Caregiver", null)
                        .WithMany()
                        .HasForeignKey("InvitedCaregiversId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
