...
public interface IHealthService
{
    ...
    Task<ActionResult<List<FallDTO>>> GetFalls(string elderEmail, DateTime date, Period period, string timezone);
    ...
    Task<ActionResult<List<Steps>>> GetSteps(string elderEmail, DateTime date, Period period, string timezone);
    Task<ActionResult<List<Kilometer>>> GetDistance(string elderEmail, DateTime date, Period period, string timezone);
    Task<ActionResult<List<Heartrate>>> GetHeartrate(string elderEmail, DateTime date, Period period, string timezone);
    Task<ActionResult<List<Spo2>>> GetSpO2(string elderEmail, DateTime date, Period period, string timezone);
}